...
$(document).on('focus','.form-control[data-datepicker]', function(){ activate_datepicker($(this)); });
$(document).on('click','a[data-datepicker]', function(e){ var target = $( $(this).attr('data-target') ); activate_datepicker(target,'show'); e.preventDefault(); });
